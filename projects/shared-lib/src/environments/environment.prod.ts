...
export const environment = {
  ...
  routes: {
    ...
    account: { url: 'account/account', breadcumb: 'Gestion des comptes' },
    sleeperAccount: { url: 'account/sleeper-account', breadcumb: 'Gestion des comptes dormants' },
    ...
    accountHistory: { url: 'account/history-account', breadcumb: 'Gestion des historiques des comptes' },
    accountOpposition: { url: 'account-opposition', breadcumb: 'Gestion des oppositions des comptes' },
    accountPosition: { url: 'account/account-postion', breadcumb: 'Gestion des positions des comptes' },
    ...
    impressionRIB: { url: 'account/print-rib', breadcumb: "Impression RIB" },
