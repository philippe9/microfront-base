...
import { AuthenticationService } from 'projects/shared-lib/src/service/authentication/authentication.service';
...
import { MICROFI_MENU } from '../../../menu';

@Component({
  selector: 'microfi-toolbar',
  templateUrl: './toolbar.component.html',
  styleUrls: ['./toolbar.component.scss']
})
export class ToolbarComponent extends AbstractComponent implements OnInit {
  appMenu = MICROFI_MENU;
  env: any;
  ...
  ngOnInit() {
    ...
    this.logger.info(this.currentUser);
    this.logger.info(this.dateComptable);
    // console.log();
  ...
  userHasPermission(code: any) {
    // let authorisedRoles = [2, 3, 5, 6, 8];
    // return authorisedRoles.includes(code);
    return false;
  }
  relogin() {
    console.log('logout')
